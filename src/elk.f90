...
! check if task can be run with MPI
  if (lp_mpi.gt.0) then
    if (any(task.eq.[0,1,2,3,5,15,16,28,29,61,62,63,110,120,125,135,136,162, &
     170,180,185,188,200,201,205,208,240,241,270,271,300,320,330,331,350,351, &
     371,372,373,440,460,461,462,463,471,478,600,610,620,630,631,640,700,701])) then
      continue
    else
...
!BOI
! !TITLE: {\huge{\sc The Elk Code Manual}}\\ \Large{\sc Version 8.4.6}\\ \vskip 20pt \includegraphics[height=1cm]{elk_silhouette.pdf}
...
!   and Xavier Gonze. Special mention of David Singh's very useful book on the
...
!
!   \vspace{12pt}
!   Berlin, Halle, Jerusalem and Uppsala, April 2022
!   \newpage
!
!   \section{Units}
