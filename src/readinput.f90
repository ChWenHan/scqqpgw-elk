...
epsdmat=1.d-8
tm3old=.false.
! batch calculation variable increments
batch=.false.
dngridk(:)=0
dlmaxapw=0
dlmaxo=0
...
!--whch-gw-------------------
case('alphagw')
  read(50,*,err=20) alphagw
case('fscgw')
  read(50,*,err=20) fscgw
case('mixse')
  read(50,*,err=20) mixse
case('calcgw')
  read(50,*,err=20) calcgw
case('readepsinv')
  read(50,*,err=20) readepsinv
case('qprenorm')
  read(50,*,err=20) qprenorm
case('hfgw')
  read(50,*,err=20) hfgw
case('maxsclgw')
  read(50,*,err=20) maxsclgw
case('tempkgw')
  read(50,*,err=20) tempkgw
case('tvse')
  read(50,*,err=20) tvse
  if (.not.calcgw) tvse=.false.
case('writeseiw')
  read(50,*,err=20) writeseiw
case('dmatfromseiw')
  read(50,*,err=20) dmatfromseiw
!-----------------------------
case('tfav0')
